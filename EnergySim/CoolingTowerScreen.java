...
public class CoolingTowerScreen extends Screen {
  ...
  public void paint(Graphics g) {
	...
	if (!laidOut) {
	  ...
	  CT_control.reshape(20 + insets.left, 5 + insets.top, ButtonControl.CONTROL_WIDTH,ButtonControl.CONTROL_HEIGHT);
	  pump_control.reshape(300 + insets.left, 300 + insets.top, ButtonControl.CONTROL_WIDTH, ButtonControl.CONTROL_HEIGHT);
	  CTST_control.reshape(150 + insets.left, 300 + insets.top, ButtonControl.CONTROL_WIDTH, ButtonControl.CONTROL_HEIGHT);
	  CTRT_label.reshape(300 + insets.left, 30 + insets.top, ButtonControl.CONTROL_WIDTH, ButtonControl.CONTROL_HEIGHT);
	  wet_bulb_control.reshape(20 + insets.left, 200 + insets.top, ButtonControl.CONTROL_WIDTH, ButtonControl.CONTROL_HEIGHT);
	  tons_control.reshape(500 + insets.left, 200 + insets.top, ButtonControl.CONTROL_WIDTH, ButtonControl.CONTROL_HEIGHT);
	  laidOut = true;
	}
  }
